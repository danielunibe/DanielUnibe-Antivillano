...
export const StackScreen: React.FC<StackScreenProps> = ({ onClose, onInspectCapability }) => {
    ...
    return (
        ...
        `}>
            ...
            {/* 2. SECTION TITLE - Centered in the top middle of the screen */}
            ...
            {/* 3. MODE SWITCHER - Top Right */}
            <div className="absolute right-4 top-3 z-40 flex items-center animate-fade-up delay-100 sm:right-6 sm:top-4">
            ...
            {/* MAIN CONTENT AREA */}
            <div className="relative z-10 flex w-full max-w-[1800px] flex-1 flex-col gap-4 overflow-visible px-3 pb-4 pt-14 min-h-0 sm:pt-16 lg:flex-row lg:gap-6 lg:overflow-hidden lg:px-8 lg:pb-3 lg:pt-16">
                {/* LEFT: Grid */}
